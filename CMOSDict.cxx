...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Seed*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Seed", ::Seed::Class_Version(), "Seed.h", 11,
...
namespace ROOT {
   static void *new_Analisi(void *p = 0);
   static void *newArray_Analisi(Long_t size, void *p);
   static void delete_Analisi(void *p);
   static void deleteArray_Analisi(void *p);
   static void destruct_Analisi(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Analisi*)
   {
      ::Analisi *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::Analisi >(0);
      static ::ROOT::TGenericClassInfo 
         instance("Analisi", ::Analisi::Class_Version(), "Analisi.h", 15,
                  typeid(::Analisi), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::Analisi::Dictionary, isa_proxy, 4,
                  sizeof(::Analisi) );
      instance.SetNew(&new_Analisi);
      instance.SetNewArray(&newArray_Analisi);
      instance.SetDelete(&delete_Analisi);
      instance.SetDeleteArray(&deleteArray_Analisi);
      instance.SetDestructor(&destruct_Analisi);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::Analisi*)
   {
      return GenerateInitInstanceLocal((::Analisi*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const ::Analisi*)0x0); R__UseDummy(_R__UNIQUE_(Init));
} // end of namespace ROOT
...
//______________________________________________________________________________
atomic_TClass_ptr Analisi::fgIsA(0);  // static to hold class pointer

//______________________________________________________________________________
const char *Analisi::Class_Name()
{
   return "Analisi";
}

//______________________________________________________________________________
const char *Analisi::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::Analisi*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int Analisi::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::Analisi*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *Analisi::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::Analisi*)0x0)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *Analisi::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::Analisi*)0x0)->GetClass(); }
   return fgIsA;
}
...
//______________________________________________________________________________
void Analisi::Streamer(TBuffer &R__b)
{
   // Stream an object of class Analisi.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(Analisi::Class(),this);
   } else {
      R__b.WriteClassBuffer(Analisi::Class(),this);
   }
}

namespace ROOT {
   // Wrappers around operator new
   static void *new_Analisi(void *p) {
      return  p ? new(p) ::Analisi : new ::Analisi;
   }
   static void *newArray_Analisi(Long_t nElements, void *p) {
      return p ? new(p) ::Analisi[nElements] : new ::Analisi[nElements];
   }
   // Wrapper around operator delete
   static void delete_Analisi(void *p) {
      delete ((::Analisi*)p);
   ...
   static void destruct_Analisi(void *p) {
      typedef ::Analisi current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::Analisi
...
"/usr/local/Cellar/root6/6.06.06/include/root",
"/Users/carlo/Software/root-install/include",
"/Users/carlo/repos/cmos/",
0
    };
...
class __attribute__((annotate("$clingAutoload$Analisi.h")))  Analisi;
)DICTFWDDCLS";

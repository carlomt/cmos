...
Analisi::Analisi(const std::string OutFileName, Double_t fcal)
{
	...
	cumulative_raggix = new TFile ("cmos/cumulative/CumulativeX.root");
	cumulative_90Sr = new TFile ("cmos/cumulative/Cumulative90Sr.root");
	cumulative_137Cs = new TFile ("cmos/cumulative/Cumulative137Cs.root");
	cumulative_60Co = new TFile ("cmos/cumulative/Cumulative60Co.root");
